 ...
 */
public class ZSettings extends PreferenceActivity
    ...
    private void updateHeaderList(List<Header> target) {
        ...
        while (i < target.size()) {
            ...
            } else if (id == R.id.zrom_section) {
                if (!onIsMultiPane()) {
                    target.remove(i);
                }
            } else if (id == R.id.interface_settings) {
                if (!onIsMultiPane()) {
                    target.remove(i);
                }
    ...
    public boolean shouldUpRecreateTask(Intent targetIntent) {
        return super.shouldUpRecreateTask(new Intent(this, ZSettings.class));
    }
